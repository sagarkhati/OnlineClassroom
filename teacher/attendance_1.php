        ...
        <div class="container-fluid"><br>
            ...
            <div class="row">
                <div class="col-sm-2">
                    ...
                    <input type="hidden" id="c" value="<?PHP echo $code1 ?>">
                </div>
                <div class="col-sm-3">
                    <center>
                        ...
                        $query = "SELECT `totalpresent` / `totalclass` * 100 AS `%attendance` FROM attendance WHERE studentname='$code1' and subjectcode='$code' ";
